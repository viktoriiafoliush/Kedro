...
# iris-databricks documentation build
...
from iris-databricks import __version__ as release

# -- Project information -----------------------------------------------------

project = "iris-databricks"
author = "Kedro"
...
htmlhelp_basename = "iris-databricksdoc"
...
texinfo_documents = [
    (
        ...
        author,
        "iris-databricks",
        "Project iris-databricks codebase.",
        "Nearest-Neighbour",
    )
]
